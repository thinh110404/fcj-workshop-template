...
5. Configure the **Default Root Object** as `index.html` and set **Custom Error Response** so that React Router client-side routes return `index.html` with HTTP `200` for `403`/`404` errors.
...
Open the CloudFront default domain in the browser: https://dfu4o0ltvpe4o.cloudfront.net
